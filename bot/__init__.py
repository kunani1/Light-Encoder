...
class Config(object):
  ...
  OWNER = list(set(int(x) for x in os.environ.get("OWNER", "5629750139").split()))
  DEV = list(set(int(x) for x in os.environ.get("DEV", "5629750139").split()))
...
bot = Client("Encoder", api_id=Config.API_ID, api_hash=Config.API_HASH, bot_token=Config.BOT_TOKEN, workers=32)
